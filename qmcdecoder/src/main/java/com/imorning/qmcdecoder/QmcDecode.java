...
public class QmcDecode extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        final QmcDecode frame = new QmcDecode();
    ...
    private void addTask(String input, String output) {
        DecodeWorker worker = new DecodeWorker(input, output);
        queue.add(worker);
        updateTaskList();
        if (currentWorker == null) {
            nextWorker();
    ...
    public void chooseFile() {
        int result = chooser.showOpenDialog(QmcDecode.this);
